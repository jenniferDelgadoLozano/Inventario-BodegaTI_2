...
________________________________________________________________________________________________________________________________________________-$_COOKIEadd_group.php:           page_require_level(1)
add_product.php:         page_require_level(2)
add_sale.php:            page_require_level(3)
add_user.php:            page_require_level(1)
admin.php:               page_require_level(1)
categorie.php:           page_require_level(1)
change_password.php:     page_require_level(3)
daily_sales.php:         page_require_level(3)
delete_categorie.php:    page_require_level(1)
delete_group.php:        page_require_level(1)
delete_media.php:        page_require_level(2)
delete_product.php:      page_require_level(2)
delete_sale.php:         page_require_level(3)
delete_user.php:         page_require_level(1)
edit_account.php:        page_require_level(3)
edit_categorie.php:      page_require_level(1)
edit_group.php:          page_require_level(1)
edit_product.php:        page_require_level(2)
edit_sale.php:           page_require_level(3)
edit_user.php:           page_require_level(1)
group.php:               page_require_level(1)
media.php:               page_require_level(2)
monthly_sales.php:       page_require_level(3)
product.php:             page_require_level(2)
profile.php:             page_require_level(3)
sale_report_process.php: page_require_level(3)
sales.php:               page_require_level(3)
sales_report.php:        page_require_level(3)
users.php:               page_require_level(1)